...
#   للإنتاج: انقله إلى Backend وسيط.
# ========================================================
...
def main(page: ft.Page):
    # -------- إعدادات الصفحة (لا تعتمد على client_storage) --------
    ...
    # ====================================================
    # --- بناء الواجهة يتم فقط بعد الاتصال بالصفحة ---
    # (هذا يحل مشكلة الشاشة البيضاء على Android)
    # ====================================================
    def on_connect(e):
        try:
            logger.info("Page connected, building UI...")
            _build_ui(page)
...
# ========================================================
# --- دالة بناء الواجهة (مفصولة لتنظيف الكود) ---
# ========================================================
def _build_ui(page: ft.Page):
    ...
    def calculate_iob():
        """
        IOB بنموذج انحلال خطي مبسّط (240 دقيقة).
        ملاحظة: النماذج الطبية الحقيقية غير خطية.
        """
        history = load_history()
    ...
    def _call_gemini(parts):
        """دالة متزامنة تُنفَّذ داخل thread منفصل."""
    ...
    # ملاحظة: التنبيهات تعمل فقط أثناء فتح التطبيق.
